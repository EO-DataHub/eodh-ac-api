...
def test_get_job_submissions_endpoint_returns_valid_response_no_params(
    ...
    # Act
    response = client.get(
        "/api/v1.1.1/action-creator/submissions", headers={"Authorization": f"Bearer {auth_token_module_scoped}"}
    )
...
@patch("src.api.v1_1_1.action_creator.routes.ades_client_factory")
...
def test_get_job_submissions_sorts_results_by_order_by_and_direction(
    ...
    # Act
    response = client.get(
        "/api/v1.1.1/action-creator/submissions",
...
def test_get_job_submissions_with_custom_per_page_item_count_and_page_idx(
    ...
    # Act
    response = client.get("/api/v1.1.1/action-creator/submissions", headers=headers, params=params)
