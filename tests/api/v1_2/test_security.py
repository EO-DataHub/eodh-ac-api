...
@pytest.mark.parametrize("api_version", ["/api/v1.2"], ids=["v1.2"])
def test_functions_endpoint_returns_forbidden_error_when_no_token_specified_v1_2(
    api_version: str,
    method: str,
    endpoint: str,
    client: TestClient,
...
@pytest.mark.parametrize("api_version", ["/api/v1.2"], ids=["v1.2"])
def test_functions_endpoint_returns_unauthorized_error_when_bad_token_v1_2(
    api_version: str,
    method: str,
    endpoint: str,
    client: TestClient,
